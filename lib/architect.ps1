...
Думай шире обычной задачи: новые роли, подсистемы, источники сигнала, паттерны из внешних систем —
но ТОЛЬКО про улучшение самой системы. Рыночные/сторонние проекты сейчас НЕ предлагай. До $MaxIdeas предложений.
"@
  } else {
    @"
