...
# Server helper modules. Keep this entrypoint focused on setup and request routing.
. (Join-Path $PSScriptRoot 'server\00-listener.ps1')
$allowLan = $false
...
. (Join-Path $PSScriptRoot 'server\10-http-io.ps1')
. (Join-Path $PSScriptRoot 'server\20-scope-runbook.ps1')
. (Join-Path $PSScriptRoot 'server\30-auth-files.ps1')
