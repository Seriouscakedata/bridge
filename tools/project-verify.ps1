...
#   Usage: powershell -NoProfile -File tools\project-verify.ps1 -Channel sample-project [-E2E] [-BaseUrl http://localhost:3100]
param([string]$Channel = 'sample-project', [switch]$E2E, [string]$BaseUrl = '')
