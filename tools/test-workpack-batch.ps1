...
try {
  ...
  $toolPathSecretText = "[deep-agent/security-model/deepseek-v4-pro] hardcoded_secrets -- The configuration file contains hardcoded paths: 'C:/Users/example/AppData/Local/OpenAI/Codex/bin/codex.exe', 'C:/Users/example/AppData/Roaming/Claude/claude-code/*/claude.exe', 'C:/Users/example/mos/bridge-canary-worktree'."
